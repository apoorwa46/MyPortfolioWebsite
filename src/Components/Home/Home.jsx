...
// import resumePDF from "../../assets/Apoorwa Kumar Resume.pdf"; 

// const Home = () => {
//   return (
//     <section
//       id="about"
//       className="w-full text-white px-6 py-12 md:py-20 flex flex-col-reverse md:flex-row items-center justify-between gap-10 md:gap-20"
//     >
//       {/* Left Content */}
...
//           <TextChange />
//         </h1>
//         <p className="text-sm md:text-lg mt-8 text-gray-400 font-medium leading-relaxed">
...
//           className="inline-block mt-6 text-white bg-[#465697] px-5 py-2 md:px-6 md:py-3 rounded-full font-semibold text-sm md:text-base hover:scale-105 hover:opacity-90 transition duration-300"
//         >
//           Download Resume
//         </a>
//       </div>
